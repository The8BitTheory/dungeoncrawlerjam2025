...
270 SLOW:BANK 15
280 BSAVE "INTERIOR2.VDC",B0,U(DD),P(DB+IS) TO P(DB+IS+(BW+1)*BH)
...
# IMAGEDATA
510 FAST:BANK0:ID=DB+OS:VP=AP+BH*80:BW=BW/2-1
520 S=TI:FOR Y=BH-1 TO 0 STEP -1
530  FOR X=0 TO BW
...
590 NEXT:S=TI-S:PRINT S
600 VTR AP,DB+IS,(BW+1)*BH:S=TI-S:PRINT S
