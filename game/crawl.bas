...
150  GET I$
152  IF I$=KB$(2) OR I$=KB$(9) THEN MI%=MI%+1:IFMI%>4THENMI%=0:GOTO 185
154  IF I$=KB$(0) OR I$=KB$(8) THEN MI%=MI%-1:IFMI%<0THENMI%=4:GOTO 185
...
# 9600 EXIT
190 ON MI%+1 GOTO 200,9000,9400,9200,9600
...
# MAIN MENU TEXT
10500 MI$(0)="PLAY!":MI$(1)="INSTRUCTIONS":MI$(2)="SETTINGS"
10501 MI$(3)="ACKNOWLEDGEMENTS":MI$(4)="EXIT"
10502 
