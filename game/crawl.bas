...
60 GS%(1)=0:FAST
61 VMF MA,0,56*32
62 FOR X=0TO28*31-1:REM 11*20-1
63  READ MV$:IF MV$="2" THEN GS%(1)=GS%(1)+1
65  IF MV$="6" THEN PP%=X:ELSE IF MV$="8" THEN TL%(TL)=X:TL=TL+1
66  MV=ASC(MV$)-48
68  M%(X)=MV:IF (MVAND1)=1 THEN MV=0:ELSEMV=255
69  ::VMW MA+X+X,MV::VMW MA+X+X+1,MV
72 NEXT
...
1000 C1=20*80+14
1001 FOR X=0TO39
1002  ::VMF C1-322+X*80,34,60
1003 NEXT
1010 ::VMC MA,C1,56,31,80
...
10312 FL=FNPW(174)-BE:PRINT FL" BYTES DONE":MA=9600
