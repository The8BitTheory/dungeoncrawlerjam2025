...
31 DIM EC%(2),PD%(2),VD%(15),GI%(3),GV%(3,3),FC%(95),T%(19),MI$(51),KB$(7),MI%(17)
...
150  GET I$
152  IF I$=KB$(2) THEN MI%=MI%+1:IFMI%>3THENMI%=0:GOTO 185
154  IF I$=KB$(0) THEN MI%=MI%-1:IFMI%<0THENMI%=3:GOTO 185
...
#    DISPLAY MAP
280  IF I$=KB$(7) THEN GOSUB 1000:GOTO320
...
9480  IF I$=KB$(2) THEN MI%=MI%+1:IFMI%>9THENMI%=0:GOTO 9500

#     MOVE UP (ALSO ACCEPTING FORWARD KEY)
9485  IF I$=KB$(0) THEN MI%=MI%-1:IFMI%<0THENMI%=9:GOTO 9500
