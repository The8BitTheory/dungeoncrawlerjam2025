...
9200 ::VMF AP,0,VR(3)
9205 C2=AP+560
9210 FOR TD = 16 TO 24
9215  C3=C2+(TD-15)*560
9220  GOSUB 975
9230 NEXT
...
9250 ::VMF AP,0,VR(3)
9255 C2=AP+560
9260 FOR TD = 25 TO 30
9265  C3=C2+(TD-24)*560
9270  GOSUB 975
9280 NEXT
...
10530 MI$(16)="SPECIAL THANKS TO ALL"
10531 MI$(17)="WHO KEPT THE VDC ALIVE":MI$(18)=" "
10532 MI$(19)="LIKE"
10533 MI$(20)=" TOKRA"
10534 MI$(21)=" OZIPHANTOM"
10535 MI$(22)=" XAHMOL"
10536 MI$(23)=" MAC BACON"
10537 MI$(24)=" WILLYMANILLY"

10540 MI$(25)="AND TO MICHAEL BROUGH"
10541 MI$(26)=" FOR BEING AN INSPIRATION"
10542 MI$(27)=" "
10543 MI$(28)="AND TO ZOOPERDAN"
10544 MI$(29)=" FOR HOSTING
10545 MI$(30)=" THE DC GAME JAMS"

10546 MI$(31)="CRAWL 128"
10547 MI$(32)=" "
10548 MI$(33)="BROUGHT TO YOU BY"
10549 MI$(34)="GOODWELL
10550 MI$(35)="AND"
10551 MI$(36)="THE 8-BIT THEORY"
