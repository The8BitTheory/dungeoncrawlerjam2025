...
36 TX$="LOADING CRAWLDATA...":GOSUB800
...
70 BANK0:TX$="POPULATING MAP...":GOSUB800
...
127 TX$="1.0C":C4%=LEN(TX$):C3=8000-480-13:GOSUB 1710
...
230 C1%=AP+EI%+EI%:C2%=AP:T3%=50:C3%=VR(1)+7840:C4%=C3%-VR(1):C5%=EI%+EI%
231 FOR X=0 TO 48
#    MOVE CURRENT SCREEN UP TWO SCANLINES
#      VMC SRC,TRG,NUM,REP,INC
232  ::VMC C1%,C2%,C5%,T3%,C5%
...
#    FIGHT
280  IF I$=KB$(6) THEN GOSUB 1300:GOTO 300

#    WAIT
285  IF I$=" " THEN GOSUB 590:GOTO 300
...
#    DISPLAY MAP
290  IF I$=KB$(7) THEN GOSUB 1000:GOTO 338

#    MENU
295  IF I$="" THEN GOSUB 1600

#    SLOW
296  IF I$="1" THEN SLOW
297  IF I$="2" THEN FAST
...
306  IF M%(PP%(0))=40 THEN TX$="EXIT CLOSED":X=0:C2=1440:GOSUB 1700
...
330   TX$="YOU ARE HIT FOR 1 POINT!":GOSUB 800

332  BEND:IF Q% THEN 338

#    UPDATE STEPS
333  IF SU% THEN TX$=MID$(STR$(GS%(2)),2):C2=AP+63:C3=C2:GOSUB 1510
...
354 C1%=CA+FC%(4):C3%=C1%+18

355 IF T%(4)=2 THEN BEGIN
356  C2%=AP+EI%*EI%+40
357  ::VMP C2%,CR$
359 BEND

360 IF FNM(3)=2 THEN BEGIN
361  C2%=AP+EI%*EI%+15-480:C5%=C3%:IF T%(4)=1 THEN C2%=C2%-3:C5%=C1%
362  ::VMC C5%,C2%,3,6,EI%
363 BEND

365 IF FNM(5)=2 THEN BEGIN
366  C2%=AP+EI%*EI%+62-480:C5%=C1%:IF T%(4)=1 THEN C2%=C2%+3:C5%=C3%
367  ::VMC C5%,C2%,3,6,EI%
368 BEND
...
376  C2%=AP+EI%*61+25:C5%=C3%:IF T%(10)=1 THEN C2%=C2%-3:C5%=C1%
377  ::VMC C5%,C2%,3,6,EI%
378 BEND

380 IF FNM(11)=2 THEN BEGIN
381  C2%=AP+EI%*61+52:C5%=C1%:IF T%(10)=1 THEN C2%=C2%+3:C5%=C3%
382  ::VMC C5%,C2%,3,6,EI%
383 BEND
...
540 IF V%=2 THEN GOSUB 600:GOTO 580:ELSE SOUND2,2000,5,,,1
...
570 IF V%=42 THEN GOSUB 1200:IF Q% THEN GOTO 338
...
610 TU%=0
611 C2=AP+3:TX$=MID$(CP$,PF%(0)+1,1)
612  ::VMP C2,TX$
614 RETURN
...
715 IF PH%(0)>0 THEN RETURN


719 TX$="YOU ARE KNOCKED OUT!":GOSUB 800

#   IF PLAYER DEAD, DISPLAY LOSE MESSAGE
720 C1%=20*EI%+8:C2%=C1%-322:C3%=C2%
730  ::VMF C3%,0,68,40,EI%

#   DISPLAY TEXT
740 TX$="YOU LOSE!":X=0:C2=1600:GOSUB 1700

750 TX$="PRESS RETURN TO RETRY":X=0:C2=32*EI%:GOSUB 1700
760 TX$="ANY OTHER KEY TO EXIT":X=0:C2=40*EI%:GOSUB 1700

780 POKE 208,0:GETKEY I$

785 Q%=-1
790 IF I$=CHR$(13) THEN RG%=2:ELSE RG%=4
...
################
1200 C1%=20*EI%+8:C2%=C1%-322:C3%=C2%+EI%

#    CREATE FRAME FOR MESSAGE
1230  ::VMF C3%,0,68,40,EI%


#    DISPLAY TEXT
1250 TX$="YOU WIN!":X=0:C2=1600:GOSUB 1700

1260 TX$="PRESS KEY TO CONTINUE":X=0:C2=32*EI%:GOSUB 1700
...
1335  X=X+1
1350 LOOP UNTIL X>4
1355 IF EN%=0 THEN TX$="YOU ATTACK... NOTHING":GOSUB 800:GOTO 1498
...
1430 IF PH%(EN%)>0 THEN GOTO 1498
...
1686  GET I$
1687  IF I$=KB$(2) OR I$=KB$(9) THEN MI%=MI%+1:IFMI%>2THENMI%=0:GOTO 1692
1688  IF I$=KB$(0) OR I$=KB$(8) THEN MI%=MI%-1:IFMI%<0THENMI%=2:GOTO 1692
1689  IF I$=CHR$(13) THEN 1694
1690  IF I$="" THEN MI%=0:I$=CHR$(13):GOTO 1694

1691  IF TI-SM<10 THEN 1686

1692  ::VMP C2," "
1693  L%=L%+1:IFL%>3THENL%=0

1694 LOOP UNTIL I$=CHR$(13)
...
2540 L%=0:MI%=0:C3=C2+1280+16:TX$=""
2545 DO
...
2570  I=ASC(I$)
2575  IF INSTR(VC$,I$)>0 AND LEN(TX$)<16 THEN BEGIN
2576   TX$=TX$+I$
2577   ::VMP C3,I$
2578   C3=C3+3
2579  BEND
...
#      REMOVE CURSOR
2582   ::VMP C3," "
2583   TX$=LEFT$(TX$,LEN(TX$)-1):C3=C3-3
2584  BEND
...
2620 OPEN1,DD,1,"@0:GREATESTCRAWL128,S"
2622 PRINT#1,"CRAWL128"
2624 FOR X=0 TO 4
2626  PRINT#1,CHR$(34)+HS$(0,X)
2628  PRINT#1,MID$(STR$(HS%(0,X)),2)
2630 NEXT
2632 CLOSE1
...
10165 TX$="LOADING WALLS...":GOSUB 800
10170 FI$="WALLS.VDC"
