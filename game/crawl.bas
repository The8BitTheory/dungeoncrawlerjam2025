...
#####
# TODO
# - HIGHSCORE (STEPS TAKEN, GHOST KILLS)
...
#233 FOR X=7840 TO T%*EI% STEP -EI%
#234  C1%=AP+X:C2%=AP+X+EI%:C3%=VR(1)+T2%
#235  ::VMC C1%,C2%,EI%
#236 NEXT:C4%=T2%:T2%=T2%+EI%
#237 ::VMC C3%,C4%,EI%
#238 T%=T%+1:IF T%<98 GOTO 232
235 ::VMC VR(1),AP,8000
...
10142 FL=FNPW(174)-BE:PRINT FL" BYTES DONE":CA=AP+VR(1)+VR(1)
10143 PRINT "COPYING TITLE TO VRAM ADDRESS "TA"-"(TA+FL)
10144 ::RTV BE,TA,FL
10145 ::VMC TA,AP+2,73,32,EI%
