...
#    STRAFE LEFT/RIGHT
270  EN%=0:IF I$="A" THEN T=FNPG(0):GOTO 520
...
#     THIS NEEDS TO TAKE VALUES FOR  STRAFE-LEFT POSITION, FORWARD POSITION, STRAFE-RIGHT POSITION

# TILE TO THE LEFT
2030 PP%=FNPG(0):X=0:GOSUB 2100

# TILE IN FRONT
2040 PP%=FNPG(1):X=1:GOSUB 2100

# TILE TO THE RIGHT
2050 PP%=FNPG(2):X=2:GOSUB 2100
...
10031 DEF FN FD(ZZ)=INT(PF%(0)+ZZ+4)-INT(INT(PF%(0)+ZZ+4)/INT(4))*INT(4)
10032 DEF FN PP(ZZ)=PP%(0)+P%(PF%(0)+PF%(0)+ZZ)
