...
150  GET I$
152  IF I$=KB$(2) THEN MI%=MI%+1:IFMI%>4THENMI%=0:GOTO 185
154  IF I$=KB$(0) THEN MI%=MI%-1:IFMI%<0THENMI%=4:GOTO 185
...
10501 MI$(2)="SETTINGS":MI$(3)="ACKNOWLEDGEMENTS":MI$(4)="EXIT"
...
10532 MI$(20)="LIKE"
10533 MI$(21)=" TOKRA"
10534 MI$(22)=" OZIPHANTOM"
10535 MI$(23)=" XAHMOL"
10536 MI$(24)=" MAC BACON"
10537 MI$(25)=" WILLYMANILLY"

10540 MI$(26)="AND TO MICHAEL BROUGH"
10541 MI$(27)=" FOR BEING AN INSPIRATION"
10542 MI$(28)=" "
10543 MI$(29)="AND TO ZOOPERDAN"
10544 MI$(30)=" FOR HOSTING
10545 MI$(31)=" THE DC GAME JAMS"
