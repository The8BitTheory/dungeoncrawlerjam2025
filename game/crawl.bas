...
106 MI%(6)=FC%(15):MI%(7)=FC%(13):MI%(8)=FC%(60):MI%(9)=FC%(92)
...
################
1200 C1%=20*EI%+8:C2%=C1%-322:C3%=C2%
...
1692  ::VMC CA,C2,3,6,EI%
1693  L%=L%+1:IFL%>9THENL%=6
...
2540 L%=6:MI%=0:C3=C2+1280+16:TX$=""
2545 DO
