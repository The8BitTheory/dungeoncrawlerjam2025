...
#    # ON TILE: FACING NORTH
#    # EAST OF TILE AND FACING WEST: RIGHT-HAND SIDE
#    # WEST OF TILE AND FACING EAST: LEFT-HAND SIDE

334  IF M%(PP%(0))=40 THEN IF PF%(0)=0 THEN TX$="EXIT CLOSED":X=0:C2=1440:GOSUB 1700
335  
336  
