...
392  IF PP%(X)=FNMP(4) AND T%(4)<>1 THEN Y=0:RD%=-1:GOSUB 850:GOTO 398
393  IF PP%(X)=FNMP(10) AND T%(10)<>1 THEN Y=1:RD%=-1:GOSUB 850:GOTO 398
394  IF PP%(X)=FNMP(3) THEN Y=0:Z=1:GOSUB 870:GOTO 398
395  IF PP%(X)=FNMP(5) THEN Y=0:Z=0:GOSUB 870
