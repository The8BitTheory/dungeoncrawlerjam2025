...
2010 GX%=FNPX(PP%(1)):PY%=FNPY(PP%(1))
2020 PD%=FNPD(0)
2030 PRINT "POSITION DELTA G1:"PD%
...
10027 DEF FN PW(ZZ)=PEEK(ZZ)+PEEK(ZZ+1)*256
10028 DEF FN M(ZZ)=M%(PP%(0)+V%(PF%(0),ZZ))
10029 DEF FN FD(ZZ)=INT(PF%(0)+ZZ+4)-INT(INT(PF%(0)+ZZ+4)/INT(4))*INT(4)
10030 DEF FN PP(ZZ)=PP%(0)+P%(PF%(0)+PF%(0)+ZZ)
10031 DEF FN TX(ZZ)=ASC(MID$(TX$,ZZ,1))-32
