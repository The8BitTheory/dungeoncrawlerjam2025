...
58 TX$="LINE 1":GOSUB 800:TX$="LINE 2":GOSUB 800
59 TX$="LINE 3":GOSUB 800:TX$="LINE 4":GOSUB 800
...
110 FOR X=0TO3:FORY=0TO3:READ MV:GV%(X,Y)=MV:NEXT
...
10400 TX$="GREETINGS, CRAWLER!":GOSUB 800

# CALCULATE TEXT-CHARACTER OFFSET POSITIONS
10410 FOR X=0TO95:FC%(X)=X*18:NEXT
