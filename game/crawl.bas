...
31 DIM EC%(2),PD%(2),VD%(15),GI%(3),GV%(3,3),FC%(95),T%(19),MI$(51),KB$(9),MI%(17),EQ%(5)
...
#    DISPLAY MAP
280  IF I$=KB$(7) THEN GOSUB 1000:GOTO 320
...
310  IF HU% THEN BEGIN
311   SOUND 3,965,10,,,,3
312   ::RGW7,132
313   ::RGW DEC("1A"),8
314   GOSUB 650
316   ::RGW DEC("1A"),DEC("FF")
317   ::RGW7,133
319   TX$="YOU ARE HIT!":GOSUB 800
320  BEND

#    UPDATE STEPS
330  IF SU% THEN TX$=MID$(STR$(GS%(2)),2):C2=AP+63:C3=C2:GOSUB 1510
...
392  IF PP%(X)=FNMP(4) THEN Y=0:RD%=-1:GOSUB 850
393  IF PP%(X)=FNMP(3) THEN Y=0:Z=ABS(FNM(4)<>1):H=ABS(FNM(4)=1):GOSUB870
394  IF PP%(X)=FNMP(5) THEN Y=0:Z=ABS(FNM(4)=1):H=ABS(FNM(4)=1):GOSUB870

395  IF PP%(X)=FNMP(10) AND FNM(4)<>1 THEN Y=1:RD%=-1:GOSUB 850:GOTO 398
396
397
...
10385 MA=GA(2):PRINT "MAP ADDRESS IN VRAM STARTING AT "MA
...
10513 MI$(8)="ATTACKRANGE IS 3 TILES"
...
10530 MI$(17)="SPECIAL THANKS TO ALL"
10531 MI$(18)="WHO KEPT THE VDC ALIVE":MI$(19)=" "
...
10540 MI$(26)="AND TO MICHAEL BROUGH"
10541 MI$(27)=" FOR BEING AN INSPIRATION"
10542 MI$(28)=" "
10543 MI$(29)="DEDICATED TO"
10544 MI$(30)=" JULIA, BEN AND MARTINA"
10545 MI$(31)=" "
...
#60003 DATA 1,2,1,0,1,0,1,1
#60004 DATA 1,6,0,0,B,0,1,1
#60005 DATA 1,0,1,0,1,0,1,1
