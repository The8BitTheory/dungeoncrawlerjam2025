...
31 DIM EC%(2),PD%(2),VD%(15),GI%(3),GV%(3,3),FC%(95),T%(19),MI$(50),KB$(7),MI%(17)
...
150  GET I$
152  IF I$="S" THEN MI%=MI%+1:IFMI%>4THENMI%=0:GOTO 185
154  IF I$="W" THEN MI%=MI%-1:IFMI%<0THENMI%=4:GOTO 185
...
9405 C2=AP+560+9
9410 FOR TD = 42 TO 50
9415  C3=C2+(TD-41)*560
9420  GOSUB 975
9430 NEXT
...
9535  C1=CA+MI%(L%):C3=AP+563+(MI%-9)*560
9540  ::VMC C1,C3,3,6,80

9550  GET I$
9552  IF I$="S" THEN MI%=MI%+1:IFMI%>18THENMI%=10:GOTO 9585
9554  IF I$="W" THEN MI%=MI%-1:IFMI%<10THENMI%=18:GOTO 9585
9556  IF I$=CHR$(13) THEN 9589

9558  IF TI-SM<10 THEN 9550

9585  ::VMC CA,C3,3,6,80
9587  L%=L%+1:IFL%>9THENL%=6

9589 LOOP UNTIL I$=CHR$(13)
...
10564 MI$(46)="LOOK LEFT:"
10565 MI$(47)="LOOK RIGHT:"
10566 MI$(48)="ATTACK:"
