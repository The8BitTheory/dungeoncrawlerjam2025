...
31 DIM EC%(2),PD%(2),VD%(15),GI%(3),GV%(3,3),FC%(95),T%(19),MI$(51),KB$(9),MI%(17)
...
311   ::RGW DEC("1A"),8
312   GOSUB 650
313   ::RGW DEC("1A"),DEC("FF")
314   TX$="YOU ARE HIT!":GOSUB 800
315  BEND

#    UPDATE STEPS
316  IF SU% THEN TX$=MID$(STR$(GS%(2)),2):C2=AP+63:C3=C2:GOSUB 1510
...
392  IF PP%(X)=FNMP(4) AND FNM(4)<>1 THEN Y=0:RD%=-1:GOSUB 850:GOTO 398
