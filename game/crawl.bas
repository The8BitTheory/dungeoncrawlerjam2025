...
230 C1%=AP+EI%:C2%=AP:T3%=99:C3%=VR(1)+7920:C4%=C3%-VR(1)
231 FOR X=0 TO 98
232  ::VMC C1%,C2%,EI%,T3%,EI%
233  T3%=T3%-1
...
# RG%=0 --> 2300: HIGHSCORE SCREEN (DECIDE THERE, WHETHER A NEW ONE HAS TO BE ENTERED)
# RG%=1 -->  200: RESTART DUNGEON
# RG%=2 -->  110: MAIN MENU (LEAVE DUNGEON WAS CHOSEN)
339 ON RG%+1 GOTO 2300,200,110
...
2300 IF GS%(1)=0 AND GS%(2)<HS%(1,4) THEN GOSUB 2500
