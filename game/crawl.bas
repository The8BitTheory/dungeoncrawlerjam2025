...
# 9600 EXIT
190 ON MI%+1 GOTO 200,9000,2300,9400,9200,9600
...
#233  C1%=AP+X:C2%=AP+X+EI%:C5%=98-T%
#234  ::VMC C1%,C2%,EI%,C5%,EI%,EI%

#235 GETKEY I$
#235 C3%=VR(1)+T2%:C4%=T2%:T2%=T2%+EI%
#236 ::VMC C3%,C4%,EI%

#237 T%=T%+1:IF T%<98 GOTO 232
...
# 2300: HIGHSCORE SCREEN (DECIDE THERE, WHETHER A NEW ONE HAS TO BE ENTERED)
# 200: RESTART DUNGEON
339 ON RG%+1 GOTO 2300,200
...
2300 IF GS%(2) > HS%(1,4) THEN 2500

2305 ::VMF AP,0,VR(3)

# DISPLAY ALL-TIME HIGHSCORES
2310 TX$="ALL TIME BEST":X=0:C2=320:GOSUB1700

2315 C2=C2+9+240
2320 FOR Y=0TO4
2325  C2=C2+560:C3=C2
2330  TX$=HS$(0,Y):C4%=LEN(TX$):GOSUB 1710
2335  TX$=MID$(STR$(HS%(0,Y)),2):C4%=LEN(TX$)
2340  C5%=(23-2-C4%)*3:C2=C2+C5%:C3=C2:C2=C2-C5%:GOSUB 1710
2350 NEXT

2400 TX$="TODAY'S BEST":X=0:C2=4320:GOSUB1700

2415 C2=C2+9+240
2420 FOR Y=0TO4
2425  C2=C2+560:C3=C2
2430  TX$=HS$(1,Y):C4%=LEN(TX$):GOSUB 1710
2435  TX$=MID$(STR$(HS%(1,Y)),2):C4%=LEN(TX$)
2440  C5%=(23-2-C4%)*3:C2=C2+C5%:C3=C2:C2=C2-C5%:GOSUB 1710
2450 NEXT
...
10055 FOR X=0TO7:PK(1,X)=PEEK(PK(0,X)):PRINT PK(0,X)":PK(1,"X")="PK(1,X):NEXT
...
10600 HS$(0,0)="AT 1":HS%(0,0)=1000
10601 HS$(0,1)="AT 2":HS%(0,1)=2000
10602 HS$(0,2)="AT 3":HS%(0,2)=3000
10603 HS$(0,3)="AT 4":HS%(0,3)=4000
10604 HS$(0,4)="AT 5":HS%(0,4)=5000

10605 HS$(1,0)="TD 1":HS%(1,0)=2000
10606 HS$(1,1)="TD 2":HS%(1,1)=4000
10607 HS$(1,2)="TD 3":HS%(1,2)=5700
10608 HS$(1,3)="TD 4":HS%(1,3)=5800
10609 HS$(1,4)="TD 5":HS%(1,4)=5900
