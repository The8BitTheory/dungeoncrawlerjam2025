...
50 DIM RL%(5,2),M%(28*31-1),V%(3,19),P%(7),GS%(1),TL%(1),MP%(2),PP%(4),FD%(3),PF%(4),RQ%(8),PH%(4)
...
285  IF I$="F" THEN GOSUB 1300:GOTO305
...
385 IF T4%<>7 THEN RETURN
386 C2=AP+80*72+35:C3=C1+36
